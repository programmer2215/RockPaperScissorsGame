...
user_score = Label(root, textvariable=user_score_var, bg="#23C4ED", font= ('Helvetica', 16, 'bold'))
user_score.grid(row=3, column=0, padx=20)

bot_score_var = StringVar(root, value='Bot\'s \nScore: ')
bot_score = Label(root, textvariable=bot_score_var, bg="#23C4ED", font= ('Helvetica', 16, 'bold'))
